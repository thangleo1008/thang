                ...
                <div class="content">
                    <div class="login">
                        <div class="login-title">
                            <h1>Nhập tài khoản để Đăng Nhập</h1>
                        </div>
                        <div class="login-account">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input class="submit-dn" type="submit" name="luu" value="Đăng nhập">
                                <ul>
                            ...
                            <?php
                                ...
                                if (isset($_POST["luu"])) {
                                    ...
                                    $pass = md5($_POST["pass"]);
                                    if($user == ""|| $pass == ""){
                                        echo "<br><br> Vui lòng nhập tài khoản và mật khẩu!";
                                    }else{
                                    ...
                                    if ($user == $kq["user"]) {
                                        ...
                                        echo "Đăng nhập lỗi! Xem lại tài khoản và mật khẩu?";
                                    }
                                }
                                }  
                        ?>
