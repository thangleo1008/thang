	...
	<div class="container">
		...
		<article>
			<div class="wrap-themsp">
				...
				<h2 style="text-align: center; padding-top: 20px; color: #1281c8;">SỬA DANH MỤC</h2>
                <?php
				include "db.php";
                    if (isset($_GET["masua"])) {
                        $masua = $_GET["masua"];
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<strong>Tên Danh Mục:</strong><input type="text" name="tendm" value="<?php echo $kq['tendm'] ?>"><br><br>
					</div>
